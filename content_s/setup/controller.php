...
class controller extends \content_s\main\controller
{
	...
	public function _route()
	{
		...
		{
			case 'setup/1':
				$this->display_name = 'content_s\setup\setup1.html';
				break;

			case 'setup/2':
				$this->display_name = 'content_s\setup\setup2.html';
				break;

			case 'setup/3':
				$this->display_name = 'content_s\setup\setup3.html';
				break;
		}

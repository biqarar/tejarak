<?php
namespace content_school\setup;
...
class controller extends \content_school\main\controller
{
	...
	public function _route()
	{
		...
		{
			case 'setup/1':
				$this->display_name = 'content_school\setup\setup1.html';
				break;

			case 'setup/2':
				$this->display_name = 'content_school\setup\setup2.html';
				break;

			case 'setup/3':
				$this->display_name = 'content_school\setup\setup3.html';
				break;
		}

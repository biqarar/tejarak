...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Select one item");                                                       // Line 123
	echo T_("Enable");                                                                // Line 238
	echo T_("Disable");                                                               // Line 239
	echo T_("Removed");                                                               // Line 127
	echo T_("Add");                                                                   // Line 53
	...
	echo T_("Two step verification");                                                 // Line 148
	echo T_("Show sidebar");                                                          // Line 115
	echo T_("Default language");                                                      // Line 50
	...
	echo T_("Enter a valid username from 3 to 40 character");                         // Line 88
	...
	echo T_("Active");                                                                // Line 124
	echo T_("Awaiting");                                                              // Line 125
	echo T_("Deactive");                                                              // Line 126
	echo T_("Filter");                                                                // Line 128
	echo T_("Unreachable");                                                           // Line 129
	echo T_("Permission");                                                            // Line 96
	echo T_("No permission");                                                         // Line 71
	...
	echo T_("Confirm password");                                                      // Line 103
	echo T_("Require to change current password");                                    // Line 103
	echo T_("Password was set, enter to change it!");                                 // Line 105
	...
	echo T_("Save remember session");                                                 // Line 139
	echo T_("Active sessions");                                                       // Line 166
	echo T_("Terminate all other sessions");                                          // Line 113
	echo T_("Browser");                                                               // Line 169
	echo T_("Operation System");                                                      // Line 170
	echo T_("IP");                                                                    // Line 24
	echo T_("Date login");                                                            // Line 172
	echo T_("Current session");                                                       // Line 174
	echo T_("Terminate");                                                             // Line 176

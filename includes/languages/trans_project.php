...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Last traffics");                                                         // Line 170
	...
	echo T_("Team is private and you can not see board!");                            // Line 21
	...
	echo T_("Member");                                                                // Line 104
	echo T_("Traffic Record");                                                        // Line 114
	echo T_("Total Hour Work");                                                       // Line 124
	echo T_("Start date of using tejarak");                                           // Line 134
	echo T_("day ago");                                                               // Line 134
	echo T_("Day Used");                                                              // Line 138
	echo T_("Top Members");                                                           // Line 164

...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Description");                                                           // Line 15
	echo T_("More");                                                                  // Line 37
	...
	echo T_("Sum hour");                                                              // Line 74
	echo T_("Hour");                                                                  // Line 78

	//----------------------------------------------content_a/report/year/display.html
	echo T_("Year");                                                                  // Line 38
	...
	echo T_("Member");                                                                // Line 109
	echo T_("Traffic Record");                                                        // Line 119
	echo T_("Total Hour Work");                                                       // Line 129
	echo T_("Start date of using tejarak");                                           // Line 139

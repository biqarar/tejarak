...
private function transtext()
{
	...
	echo T_("Personal Card");                                                         // Line 3
	echo T_("A beautiful and quick way to attendance");                               // Line 6
	echo T_("Personal Cards");                                                        // Line 13
	echo T_("Submit your order");                                                     // Line 21
	...
	echo T_("Change Plan");                                                           // Line 12
	echo T_("Report");                                                                // Line 15
	echo T_("Attendance");                                                            // Line 17

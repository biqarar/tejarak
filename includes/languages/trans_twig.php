...
private function transtext()
{
	...
	echo T_("Scan Barcode here...");                                                  // Line 200
	echo T_("Rfid");                                                                  // Line 205
	echo T_("Scan Rfid here...");                                                     // Line 207
	echo T_("Qrcode");                                                                // Line 212
	echo T_("Scan Qrcode here...");                                                   // Line 214

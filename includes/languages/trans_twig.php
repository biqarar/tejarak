...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Add new Gateway");                                                       // Line 16
	...
	echo T_("Type your message here...");                                             // Line 11

	//------------------------------------------content_a/billing/invoice/display.html
	echo T_("Invoice Detail");                                                        // Line 7
	echo T_("Check invoice and detail of it");                                        // Line 8
	echo T_("Factor of team");                                                        // Line 13
	...
	echo T_("Amount");                                                                // Line 29
	echo T_("Checkout");                                                              // Line 30
	echo T_("If you have a promo code, please enter it below to receive your credit.");// Line 38
	echo T_("Apply Code");                                                            // Line 44
	echo T_("Your credit");                                                           // Line 59
	echo T_("Click to check detail");                                                 // Line 62
	echo T_("Usage");                                                                 // Line 18
	echo T_("Billing History");                                                       // Line 78
	echo T_("Value");                                                                 // Line 84
	echo T_("Budget After");                                                          // Line 85
	echo T_("Invoice");                                                               // Line 86

	//-------------------------------------------content_a/billing/detail/display.html
	echo T_("Usage Detail");                                                          // Line 5
	echo T_("Check your current usage and active user and price for this period of time.");// Line 6
	echo T_("Start plan");                                                            // Line 16
	echo T_("Active member");                                                         // Line 17

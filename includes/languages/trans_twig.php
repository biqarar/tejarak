...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Amount");                                                                // Line 25
	echo T_("Checkout");                                                              // Line 26
	echo T_("Promo code");                                                            // Line 43
	echo T_("If you have a promo code, please enter it below to receive your credit.");// Line 34
	echo T_("Promo Code");                                                            // Line 65
	echo T_("Apply Code");                                                            // Line 40
	echo T_("Your credit");                                                           // Line 55
	echo T_("Click to check detail");                                                 // Line 58
	echo T_("Billing History");                                                       // Line 74

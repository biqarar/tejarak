...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Status");                                                                // Line 104
	echo T_("Visibility");                                                            // Line 124
	...
	//--------------------------------------------content_a/teamdashboard/display.html

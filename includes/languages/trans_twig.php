...
private function transtext()
{
	...
	echo T_("Personal Card");                                                         // Line 13
	echo T_("A beautiful and quick way to attendance");                               // Line 14
	echo T_("Submit your order");                                                     // Line 24
	echo T_("Logo and branding");                                                     // Line 34
	echo T_("Barcode");                                                               // Line 88
	echo T_("Custom design");                                                         // Line 106
	echo T_("Fast delivery");                                                         // Line 130
	echo T_("Good cost");                                                             // Line 148
	echo T_("Interested?");                                                           // Line 166
	echo T_("Order your personal cards");                                             // Line 168
	...
	echo T_("Amount");                                                                // Line 52
	echo T_("Checkout");                                                              // Line 53
	echo T_("Promo code");                                                            // Line 62
	echo T_("If you have a promo code, please enter it below to receive your credit.");// Line 63
	echo T_("Promo Code");                                                            // Line 68
	echo T_("Apply Code");                                                            // Line 69
	echo T_("Billing History");                                                       // Line 82
	...
	echo T_("Edit");                                                                  // Line 115
	echo T_("Add");                                                                   // Line 124
	...
	echo T_("Diff - Minus");                                                          // Line 64

	//---------------------------------------------content_a\report\month\display.html
	echo T_("Year");                                                                  // Line 11
	...
	echo T_("Count");                                                                 // Line 13
	echo T_("Total");                                                                 // Line 18

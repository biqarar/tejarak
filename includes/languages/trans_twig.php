...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("email");                                                                 // Line 74
	echo T_("Your email");                                                            // Line 76
	echo T_("Money unit");                                                            // Line 84
	echo T_("Please select one unit for default");                                    // Line 94
	echo T_("$");                                                                     // Line 96
	echo T_("Dollar");                                                                // Line 110
	echo T_("Update profile");                                                        // Line 119
	...
	echo T_("Start your work at date");                                               // Line 24
	echo T_("End your work at date");                                                 // Line 32
	echo T_("Start time");                                                            // Line 42
	echo T_("End time");                                                              // Line 51
	echo T_("You can set some description for this request");                         // Line 58

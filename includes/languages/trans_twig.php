...
private function transtext()
{
	...
	echo T_("Change Plan");                                                           // Line 13
	echo T_("Report");                                                                // Line 17
	echo T_("Attendance");                                                            // Line 19
	...
	echo T_("Invoice Detail");                                                        // Line 9
	echo T_("Title");                                                                 // Line 86
	echo T_("invoice History");                                                       // Line 21

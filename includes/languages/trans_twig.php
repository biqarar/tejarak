...
private function transtext()
{
	...
	echo T_("What are you waiting for?");                                             // Line 48
	echo T_("Not sure how to start?");                                                // Line 49
	echo T_("Tejarak is <span>free</span> to use as long as you want for teams of all sizes.");// Line 49
	echo T_("Not worries.");                                                          // Line 49
	echo T_("FREE ticket to Enter to the 21st century!");                             // Line 51
	echo T_("You can easily upgrade to ");                                            // Line 53
	echo T_("our paid plans");                                                        // Line 53
	echo T_(", which offer more features and controls.");                             // Line 53
	echo T_("Our technology team with flexible time in addition of introduce team members, use Tejarak for register remote and wasted time for working hours and attendance.");// Line 63
	echo T_("Ermile Preview");                                                        // Line 127
	echo T_("Since use Tejrak for control rooms status, we have a completly real time monitoring and we reach mpre success on room sales planning with analysis reports.");// Line 71
	echo T_("Wherever You Go");                                                       // Line 86
	echo T_("Enjoy your travels and do not be too concerned about control attendance in your business.");// Line 87
	echo T_("Everything is in sync.");                                                // Line 87
	echo T_("In addition of website, without need to install app, check real time reports of staffs status from messengers like <span>Telegram</span>, SMS, email in your mobile.");// Line 88
	echo T_("Anywhere, from sitting on the chair of management to sitting on the beach!");// Line 88
	echo T_("Work With Any Team");                                                    // Line 131
	echo T_("For each work need attendance use Tejarak!");                            // Line 132
	...
	echo T_("Set up a team in less than a minute!");                                  // Line 167
	echo T_("It's FREE!");                                                            // Line 167
	...
	echo T_("24H");                                                                   // Line 52
	echo T_("Minus");                                                                 // Line 38
	echo T_("Plus");                                                                  // Line 39
	...
	echo T_("Diff");                                                                  // Line 37

	//------------------------------------------------content_s/gateway/dashboard.html
	echo T_("Add new Gateway");                                                       // Line 15
	...
	echo T_("Server Timezone");                                                       // Line 65
	echo T_("Group Setting");                                                         // Line 71
	echo T_("Telegram Group");                                                        // Line 75
	echo T_("Delete Group");                                                          // Line 81
	echo T_("Send first memeber name");                                               // Line 88
	echo T_("Send report daily at end of day");                                       // Line 95
	...
	echo T_("Card size");                                                             // Line 125
	echo T_("Auto size");                                                             // Line 127
	echo T_("Small");                                                                 // Line 128
	echo T_("Medium");                                                                // Line 129
	echo T_("Large");                                                                 // Line 130
	echo T_("Language");                                                              // Line 137
	echo T_("Please select one language");                                            // Line 139
	echo T_("Persian");                                                               // Line 140
	echo T_("English");                                                               // Line 141
	echo T_("Event title");                                                           // Line 148
	echo T_("Event date");                                                            // Line 153
	echo T_("Close");                                                                 // Line 166
	echo T_("Advance");                                                               // Line 236
	...
	//-------------------------------------------content_s/member/student/student.html
	echo T_("Add new student");                                                       // Line 6
	echo T_("Search in students list");                                               // Line 11
	echo T_("Family");                                                                // Line 21
	echo T_("Father");                                                                // Line 67
	echo T_("Gender");                                                                // Line 65
	echo T_("Birthday");                                                              // Line 60
	echo T_("National code");                                                         // Line 45
	...
	//-------------------------------------------content_s/member/teacher/teacher.html
	echo T_("Add new teacher");                                                       // Line 6
	echo T_("Search in teachers list");                                               // Line 11

	//---------------------------------------content_s/member/teacher/teacher_add.html
	...
	echo T_("Visible");                                                               // Line 133
	echo T_("Hidden");                                                                // Line 137
	echo T_("Parent");                                                                // Line 145
	echo T_("Add new parent");                                                        // Line 58
	echo T_("Parent mobile");                                                         // Line 169
	...
	echo T_("Teachers");                                                              // Line 13
	echo T_("Students");                                                              // Line 14
	echo T_("Classroom");                                                             // Line 15
	echo T_("Lessons");                                                               // Line 50

	//----------------------------------------------------content_s/main/teamLink.html
	echo T_("Show member");                                                           // Line 1
	echo T_("Team Settings");                                                         // Line 2
	echo T_("Change Plan");                                                           // Line 14
	echo T_("Report");                                                                // Line 18
	...
	echo T_("Lesson");                                                                // Line 16
	echo T_("School Terms");                                                          // Line 17
	...
	//--------------------------------------------------content_s/terms/termsList.html
	echo T_("Add new terms");                                                         // Line 6

	//----------------------------------------------------content_s/terms/display.html

	//-----------------------------------------------content_s/sendnotify/display.html
	echo T_("Send message to user");                                                  // Line 5
	echo T_("You can send every message to your team member");                        // Line 6
	echo T_("Message text");                                                          // Line 8
	echo T_("Type your message here...");                                             // Line 9

	//------------------------------------------content_s/billing/invoice/display.html
	echo T_("Invoice Detail");                                                        // Line 8

	//--------------------------------------------------content_s/billing/display.html
	echo T_("Your credit");                                                           // Line 17
	echo T_("Earn More Credit");                                                      // Line 20
	echo T_("Usage");                                                                 // Line 15
	echo T_("View Usage Details");                                                    // Line 31
	echo T_("Charge your account");                                                   // Line 39
	echo T_("Choose a gateway and enter an amount to charge your account");           // Line 40
	echo T_("Amount");                                                                // Line 59
	echo T_("Checkout");                                                              // Line 60
	echo T_("Promo code");                                                            // Line 69
	echo T_("If you have a promo code, please enter it below to receive your credit.");// Line 70
	echo T_("Promo Code");                                                            // Line 75
	echo T_("Apply Code");                                                            // Line 76
	echo T_("Billing History");                                                       // Line 89
	echo T_("Budget");                                                                // Line 91
	echo T_("Unit");                                                                  // Line 92
	echo T_("Invoice");                                                               // Line 96
	echo T_("-");                                                                     // Line 114
	...
	//--------------------------------------------content_s/notifications/display.html
	...
	echo T_("Billing information");                                                   // Line 5

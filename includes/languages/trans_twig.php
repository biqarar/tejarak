...
private function transtext()
{
	...
	echo T_("Setup your dedicated and beautiful attendance system in less than a minute and have a <span>real time</span> and scrupulously monitoring on your business from anywhere");// Line 27
	...
	echo T_("Gender");                                                                // Line 66
	echo T_("Birthday");                                                              // Line 61
	...
	echo T_("Marital");                                                               // Line 83
	echo T_("Married");                                                               // Line 92
	echo T_("Child count");                                                           // Line 102
	echo T_("Birth city");                                                            // Line 109
	echo T_("Sh from");                                                               // Line 118
	echo T_("Sh code");                                                               // Line 125
	echo T_("Last education");                                                        // Line 133
	echo T_("Job");                                                                   // Line 140
	echo T_("Pasport code");                                                          // Line 148
	echo T_("Pasport expire");                                                        // Line 156
	...
	echo T_("Bank account number");                                                   // Line 163
	echo T_("Shaba number");                                                          // Line 168
	echo T_("Last education degree");                                                 // Line 170
	...
	echo T_("Term");                                                                  // Line 57
	echo T_("School Terms");                                                          // Line 17
	echo T_("Lessons");                                                               // Line 70
	...
	echo T_("Lesson subject");                                                        // Line 16
	echo T_("Lesson");                                                                // Line 18
	...
	echo T_("Medium");                                                                // Line 128
	echo T_("Large");                                                                 // Line 129
	echo T_("Language");                                                              // Line 136
	echo T_("Please select one language");                                            // Line 138
	echo T_("Persian");                                                               // Line 139
	echo T_("English");                                                               // Line 140
	echo T_("Event title");                                                           // Line 147
	echo T_("Event date");                                                            // Line 152

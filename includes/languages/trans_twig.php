...
private function transtext()
{
	...
	echo T_("In the Name of God");                                                    // Line 43
	echo T_("Enter");                                                                 // Line 26
	echo T_("I was on the mission");                                                  // Line 95
	echo T_("Exit");                                                                  // Line 128
	...
	echo T_("Edit");                                                                  // Line 145
	echo T_("Add");                                                                   // Line 154
	...
	echo T_("allowed extentions jpg, png (gif for bussiness plans). Max 500Kb");      // Line 25
	...
	echo T_("Scan Barcode here...");                                                  // Line 194
	echo T_("Rfid");                                                                  // Line 199
	echo T_("Scan Rfid here...");                                                     // Line 201
	echo T_("Qrcode");                                                                // Line 206
	echo T_("Scan Qrcode here...");                                                   // Line 208
	echo T_("Advance");                                                               // Line 151
	...
	echo T_("Event title");                                                           // Line 124
	echo T_("Event date");                                                            // Line 129

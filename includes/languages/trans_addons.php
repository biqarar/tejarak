...
private function transtext()
{
	...
	echo T_("Sample Design");                                                         // Line 11
	echo T_("Last update on");                                                        // Line 20
	echo T_("wait for next version!");                                                // Line 20
	echo T_("Powered by");                                                            // Line 22
	...
	echo T_("Extract twig trans func in saloos addons");                              // Line 23
	echo T_("Extract twig trans func in saloos addons and update on saloos addons");  // Line 24
	...
	echo T_("Profile");                                                               // Line 382 Seperate
	...
	echo T_("Windows");                                                               // Line 343 Seperate
	echo T_("Linux");                                                                 // Line 344 Seperate
	echo T_("Mac");                                                                   // Line 345 Seperate
	echo T_("Chrome");                                                                // Line 346 Seperate
	echo T_("Gecko");                                                                 // Line 347 Seperate
	echo T_("First you must enter name of permission");                               // Line 351 Seperate
	echo T_("This permission name exist!");                                           // Line 352 Seperate
	echo T_("You can edit this permission");                                          // Line 353 Seperate
	echo T_("Define or edit user permissions to allow or block access to special pages");// Line 354 Seperate
	echo T_("You are editing permission");                                            // Line 355 Seperate
	echo T_("We send a verification code for you");                                   // Line 359 Seperate
	echo T_("We send a verification code to this number");                            // Line 360 Seperate
	echo T_("You account is verified successfully");                                  // Line 361 Seperate
	echo T_("Your verification code is");                                             // Line 362 Seperate
	echo T_("Your password is changed successfully");                                 // Line 363 Seperate
	echo T_("Now we only support IRAN!");                                             // Line 364 Seperate
	echo T_("Thanks for using our service");                                          // Line 366 Seperate
	echo T_("Dear user");                                                             // Line 371 Seperate
	echo T_("For using this service we need to register your phone number.");         // Line 372 Seperate
	echo T_("Please send your number with below keyboard to complete registeration.");// Line 373 Seperate
	echo T_("Dear friend");                                                           // Line 374 Seperate
	echo T_("We need your phone number to verifying your account.");                  // Line 375 Seperate
	echo T_("If you dont want share your number, we cant presenting our services to you!");// Line 376 Seperate
	echo T_("Registering user is successful.");                                       // Line 377 Seperate
	echo T_("Cancel registration and return to main menu");                           // Line 378 Seperate
	echo T_("Please only use below keyboard");                                        // Line 379 Seperate
	echo T_("We need your contact!");                                                 // Line 380 Seperate
	echo T_("Register User 📱");                                                       // Line 383 Seperate
	echo T_("Register User");                                                         // Line 384 Seperate
	echo T_("Return");                                                                // Line 385 Seperate
	echo T_("Register Mobile Number 📱");                                              // Line 386 Seperate
	echo T_("Register Mobile Number");                                                // Line 387 Seperate
	echo T_("Register Address");                                                      // Line 388 Seperate
	echo T_("By completing your profile, help us to present better service.");        // Line 389 Seperate
	echo T_("We will thank you for this.");                                           // Line 390 Seperate
	echo T_("Your phone number registered successfully;)");                           // Line 392 Seperate
	echo T_("We dont need another users contact:?)");                                 // Line 393 Seperate
	echo T_("We need mobile number!");                                                // Line 394 Seperate
	echo T_(" ");                                                                     // Line 396 Seperate
	echo T_("east azerbaijan");                                                       // Line 400 Seperate
	echo T_("west azerbaijan");                                                       // Line 401 Seperate
	echo T_("ardabil");                                                               // Line 402 Seperate
	echo T_("esfahan");                                                               // Line 403 Seperate
	echo T_("alborz");                                                                // Line 404 Seperate
	echo T_("eilam");                                                                 // Line 405 Seperate
	echo T_("bushehr");                                                               // Line 406 Seperate
	echo T_("tehran");                                                                // Line 407 Seperate
	echo T_("chaharmahal and bakhtiari");                                             // Line 408 Seperate
	echo T_("south khorasan");                                                        // Line 409 Seperate
	echo T_("razavi khorasan");                                                       // Line 410 Seperate
	echo T_("north khorasan");                                                        // Line 411 Seperate
	echo T_("khuzestan");                                                             // Line 412 Seperate
	echo T_("zanjan");                                                                // Line 413 Seperate
	echo T_("semnan");                                                                // Line 414 Seperate
	echo T_("sistan and baluchestan");                                                // Line 415 Seperate
	echo T_("fars");                                                                  // Line 416 Seperate
	echo T_("qazvin");                                                                // Line 417 Seperate
	echo T_("kordestan");                                                             // Line 419 Seperate
	echo T_("kerman");                                                                // Line 420 Seperate
	echo T_("kermanshah");                                                            // Line 421 Seperate
	echo T_("kohgiluyeh and boyerahmad");                                             // Line 422 Seperate
	echo T_("golestan");                                                              // Line 423 Seperate
	echo T_("gilan");                                                                 // Line 424 Seperate
	echo T_("lorestan");                                                              // Line 425 Seperate
	echo T_("mazandaran");                                                            // Line 426 Seperate
	echo T_("markazi");                                                               // Line 427 Seperate
	echo T_("hormozgan");                                                             // Line 428 Seperate
	echo T_("hamedan");                                                               // Line 429 Seperate
	echo T_("yazd");                                                                  // Line 430 Seperate
	...
	echo T_("Enter a valid eamil!");                                                  // Line 225
	...
	echo T_("Login with mobile");                                                     // Line 136
	echo T_("Enter with Google");                                                     // Line 156
	echo T_("Login with email");                                                      // Line 165
	echo T_("Login with username");                                                   // Line 174
	echo T_("Resend code");                                                           // Line 218
	echo T_("New email");                                                             // Line 225
	echo T_("New username");                                                          // Line 233
	echo T_("Enter a valid username!");                                               // Line 233

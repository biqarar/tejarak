...
class notifications
{
	...
	public $notification_title   = ['null'=>'NO'  ,'show'=>'YES'     ,'label'=>'title'           ,'type'=>'varchar@100'];
	public $notification_content = ['null'=>'YES' ,'show'=>'YES'     ,'label'=>'content'         ,'type'=>'varchar@100'];
	...
	{
		$this->form()->type('text')->name('content')->maxlength('100');
	}
